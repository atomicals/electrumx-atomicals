...
from electrumx.lib.util_atomicals import SUBREALM_MINT_PATH, MINT_SUBREALM_RULES_BECOME_EFFECTIVE_IN_BLOCKS, convert_db_mint_info_to_rpc_mint_info_format, compact_to_location_id_bytes, location_id_bytes_to_compact, is_compact_atomical_id
...
class ElectrumX(SessionBase):
    ...
    async def atomical_id_get_state(self, compact_atomical_id, path, Verbose=False):
        atomical_id = compact_to_location_id_bytes(compact_atomical_id)
        atomical = await self.atomical_id_get(compact_atomical_id)
